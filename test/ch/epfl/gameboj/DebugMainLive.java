...
public final class DebugMainLive extends Application {
	...
	private static final String ROM_PATH = "C:\\Users\\Oscar Pitcho\\git\\GameBoyV2\\flappyBoy.gb";
	...
	private static final Image getImage(GameBoy gb) {
		...
		BufferedImage bufferedImage = new BufferedImage(lcdImage.getWidth(), lcdImage.getHeight(),
